        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    contentCustomer = contentCustomer.Replace("{{Phone}}", order.CustomerPhone);
                    ...
                    WebBanHangOnline.Common.Common.SendMail("Linh kiện Online", "Đơn hàng #" + order.Code, contentCustomer.ToString(), order.Email);
                    ...
                    contentAdmin = contentAdmin.Replace("{{Phone}}", order.CustomerPhone);
